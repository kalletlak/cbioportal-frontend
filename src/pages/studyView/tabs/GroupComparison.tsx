...
import styles from "./groupComparisonTabStyles.module.scss";
...
export class GroupComparison extends React.Component<IGroupComparisonProps, {}> {
    @observable activeTabId = 'overlap';
        ...
        return (
            <div className={styles.main} style={{ margin: '10px' }} >
                ...
                <MSKTabs id="groupComparisonTabs" activeTabId={this.activeTabId}
                    ...
                    <MSKTab key={2} id="mutations" linkText="Mutations">

                    </MSKTab>
                    <MSKTab key={3} id="copyNumber" linkText="Copy-Number">

                    </MSKTab>
                    <MSKTab key={4} id="expression" linkText="Expression">
